      ...
      <div className='mt-2 px-1 pb-1'>
        ...
        {filteredDocuments?.map((document) => (
          <div
            key={document._id}
            role='button'
            onClick={() => handleNavigate(document._id)}
          ...
          >
            ...
            <div className='flex items-center'>
              <div
                ...
                className='rounded-sm p-2 hover:bg-neutral-200 dark:hover:bg-neutral-600 text-muted-foreground hover:text-green-400'
              >
              ...
              <ConfirmModal onConfirm={() => onRemove(document._id)}>
                <div
                  role='button'
                  className='rounded-sm p-2 hover:bg-neutral-200 dark:hover:bg-neutral-600 text-muted-foreground hover:text-red-400'
                >
